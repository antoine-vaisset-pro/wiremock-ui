...
import {SwaggerParserOpenApiParserService} from "./swagger-parser-openapi-parser.service";
// --- Shared fixtures ---------------------------------------------------------
...
// Run the full IOpenApiParserService contract against OpenApiParserService.
describeIOpenApiParserService('OpenApiParserService', () =>
    TestBed.inject(OpenApiParserService)
);

// Run the full IOpenApiParserService contract against SwaggerParserOpenApiParserService.
describeIOpenApiParserService('SwaggerParserOpenApiParserService', () =>
    TestBed.inject(SwaggerParserOpenApiParserService)
);
